    ...
    function appendInfoTable(_infoTableInputArr) {
        ...
        $.each(_infoTableInputArr, function(index, obj) {
            ...
            $('#' + divs.infoTableDivId).append(
              '<tr><td style="width: 200px; text-align:right;"></td><td style="width: 300px; text-align:center;"><b style="color : ' + color + ';">' 
              + obj.groupName + '</b></td></tr>' + 
              '<tr><td style="width: 200px; text-align:right;">' 
              + text.infoTableTitles.total_cases + '</td><td style="width: 300px; text-align:center;"><b>' 
              + obj.num_cases + '</b></td></tr>' + 
              '<tr><td style="width: 200px; text-align:right;">' 
              + text.infoTableTitles.num_of_events_cases + '</td><td style="width: 300px; text-align:center;"><b>' 
              + obj.num_of_events_cases + '</b></td></tr>' + 
              '<tr><td style="width: 200px; text-align:right;">' 
              + text.infoTableTitles.median + '</td><td style="width: 300px; text-align:center;"><b>' 
              + obj.median.toFixed(2) + '</b></td></tr>' 
            );
            // $("#" + divs.infoTableDivId).append("<tr>" +
            //                                     "<td>" + obj.groupName + "</td>" +
            //                                     "<td><b>" + obj.num_cases + "</b></td>" +
