...
config.exclusivity.division = {
	margin: [10, 40, 0, 50],
	attr: {
		x: function (d, i) {return i > 0 ? this.isText ? this.scale(this.axis[this.axis.length - 1]) - draw.getTextWidth(d.text.toUpperCase()) - this.m.left + this.padding * 1.5 : this.scale(d.point) : this.isText ? this.m.left + this.padding : this.m.left;},
