...
var exclusivityConfig = function ()	{
	'use strict';
...
/*
	Landscape 의 Scale option group 을 만들어주는 객체.
 */
...
(function (whole)	{
	...
	console.log(whole, bio)

	whole.bio = bio;
}(window||{}));
/*
	각 객체의 Model 값의 초기값을 찾아
	반환해주는 함수.
 */
...
var pathway = function ()	{
	...
	function colorGenes (data, patient)	{
		var texts = d3.selectAll('text').nodes();
...
var preprocExclusivity = function ()	{
	'use strict';
...
var preprocExpression = function ()	{
	'use strict';
...
/*
	Chart 별 사전 데이터 처리 및 가공을 수행하는 객체.
 */
