...
function sizing ()	{
	...
	model.chart.expression = function (ele, w, h)	{
		var id = {
			...
			expression_bar_plot: {width: w * 0.395, height: h * 0.32},
			...
			expression_division: {width: w * 0.395, height: h * 0.04},
			expression_scatter_plot: {width: w * 0.395, height: h * 0.3},
			expression_scatter_empty: {width: w * 0.2, height: h * 0.08},
			expression_scatter_legend: {width: w * 0.2, height: h * 0.2},
			expression_heatmap: {width: w * 0.395, height: h * 0.25},
